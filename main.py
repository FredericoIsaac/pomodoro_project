...
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)  # The size of the tomato.png
tomato_img = PhotoImage(file="tomato.png")  # Grab the image so we can manipulate
canvas.create_image(100, 112, image=tomato_img)  # 103 e 112 is the center of the image vs canvas
